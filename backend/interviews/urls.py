...
from interviews.audio_views import InterviewRoundAudioUploadView
...
urlpatterns = [
    ...
    path('<int:interview_id>/rounds/<int:round_id>/audio/', InterviewRoundAudioUploadView.as_view(), name='interview_round_audio_upload'),
