...
class Recommendation(models.Model):
    ...
    recommendation_type = models.CharField(
        max_length=20, choices=TYPE_CHOICES, verbose_name="推荐类型"
    )
    ...
    related_dimension = models.CharField(
        max_length=100, blank=True, null=True, verbose_name="关联维度"
    )
    related_knowledge_point = models.ForeignKey(
...
class UserProgress(models.Model):
    ...
    completed_recommendations = models.IntegerField(
        default=0, verbose_name="已完成推荐数"
    )
...
class VoiceLlmResult(models.Model):
    interview = models.OneToOneField(
        ...
        db_column="interview_id",
        related_name="recommendation_voice_llm_result",
    )
